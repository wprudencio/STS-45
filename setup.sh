...
echo "  (or: ~/.llama-app/llama serve -m models/gemma-4-E2B-UD-Q2.gguf --host 127.0.0.1 --port 8080 --no-kv-offload -b 512 --cache-type-k q4_0 --cache-type-v q4_0 --reasoning off)"
echo ""
echo "Then run:  ./start.sh"
echo ""
echo "Open: http://localhost:7777"
echo ""
echo "With Cloudflare Tunnel (public URL):"
echo "  ./start.sh --cf"
echo "  # or: CLOUDFLARE=1 ./start.sh"
echo ""
